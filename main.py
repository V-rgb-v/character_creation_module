...
def attack(char_name: str, char_class: str) -> str:
    """Define the attack strength based on a character class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Define the defence strength based on a character class."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не блокировал урок')
...
def choice_char_class() -> str:
    """Choose the class of a character."""
    approve_choice: str = ''
    char_class: str = ''
